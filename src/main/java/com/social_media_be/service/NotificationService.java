...
public interface NotificationService {
    void createAndSendNotification(User receiver, User actor, NotificationType type, Long referenceId, Long targetId);
    Page<NotificationResponse> getNotifications(Long userId, Pageable pageable);
    long getUnreadCount(Long userId);
    void markAsRead(Long notificationId, Long userId);
    void markAllAsRead(Long userId);
    void removeLikeNotification(User actor, NotificationType type, Long referenceId);
    void removeNotificationByPostId(Long postId);
}
